...
C = Conscience coefficient (0 ≤ C < 1)`}
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <div className="inline-block bg-neon-orange/30 px-3 py-1 rounded-full text-sm mb-3 font-pixel flex items-center space-x-2">
                    <Shield size={16} className="text-neon-orange animate-pulse" />
                    <span>Apocalypse Economic Theory</span>
                  </div>
                  
                  <div className="space-y-4">
                    <div>
                      <h4 className="font-bold text-neon-red mb-2 font-pixel w-full">Absurdity Singularity:</h4>
                      <p className="text-gray-300 text-xs font-pixel mb-1 w-full">
                        What happens when meme density approaches infinity:
                      </p>
                      <ul className="list-disc pl-5 space-y-1 text-gray-300 text-xs font-pixel w-full">
                        <li>Quantum singularity forms inside meme-space</li>
                        <li>NASDAQ servers start mining AIB automatically</li>
                        <li>Warren Buffett involuntarily tweets "WAGMI"</li>
                      </ul>
                    </div>
                    
                    <div>
                      <h4 className="font-bold text-neon-green mb-2 font-pixel w-full">AIB/BTC Flippening:</h4>
                      <p className="text-gray-300 text-xs font-pixel mb-1 w-full">
                        The real crypto apocalypse:
                      </p>
                      <ul className="list-disc pl-5 space-y-1 text-gray-300 text-xs font-pixel w-full">
                        <li>When 1 AIB > 1 BTC, world leaders must only speak in memes</li>
                        <li>Satoshi's true identity revealed: a committee of 5 cats typing on keyboards</li>
                        <li>Proof-of-Absurdity becomes global currency standard</li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            >
              <div>
                <div className="inline-block bg-neon-blue/30 px-3 py-1 rounded-full text-sm mb-3 font-pixel flex items-center space-x-2">
                  <Wallet size={16} className="text-neon-blue animate-pulse" />
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between glassmorphism p-3 rounded-lg">
                    <div className="flex items-center space-x-2">
                      <Box className="text-neon-green" size={18} />
                      <span className="text-white font-mono text-xs">0x71C7656EC7ab88b098defB751B7401B5f6d8976F</span>
                    </div>
                    <button 
                      className="text-neon-green hover:text-neon-blue transition-colors"
                      onClick={() => copyToClipboard("0x71C7656EC7ab88b098defB751B7401B5f6d8976F", "Contract address copied to clipboard!")}
                    >
                      <Copy size={16} />
                    </button>
                  </div>
                  ...
                  <div className="text-xs text-gray-300 font-pixel">
                    <p>The AIbsurdity (AIB) token contract carefully avoids implementing any useful features:</p>
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                      <li>No staking mechanisms (just makes things too serious)</li>
                      <li>No governance (democracy is overrated; memes decide everything)</li>
                      <li>No burn function (even our code refuses to work)</li>
                    </ul>
                  </div>
                  
                  <div className="flex items-center space-x-2 mt-4">
                    <a href="https://etherscan.io" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-1 bg-neon-blue/20 hover:bg-neon-blue/30 text-neon-blue px-3 py-1.5 rounded-full text-xs font-pixel transition-colors">
                      <Github size={14} />
                      <span>View Contract</span>
                    </a>
                    <a href="https://uniswap.org" target="_blank" rel="noopener noreferrer" className="inline-flex items-center space-x-1 bg-neon-pink/20 hover:bg-neon-pink/30 text-neon-pink px-3 py-1.5 rounded-full text-xs font-pixel transition-colors">
                      <Send size={14} />
            ...
            >
              <div>
                <div className="inline-block bg-neon-purple/30 px-3 py-1 rounded-full text-sm mb-3 font-pixel flex items-center space-x-2">
                  <Briefcase size={16} className="text-neon-purple animate-pulse" />
                  <span>AIbsurdity Fund</span>
                </div>
                
                <h3 className="text-xl font-bold mb-3 text-neon-purple font-pixel w-full">
                  Absurdly Inverse Hedge Fund
                </h3>
                
                <div className="space-y-4">
                  <div className="flex items-center justify-between glassmorphism p-3 rounded-lg">
                    <div className="flex items-center space-x-2">
                      <BarChart3 className="text-neon-purple" size={18} />
                      <span className="text-white font-mono text-xs">0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199</span>
                    </div>
                    <button 
                      className="text-neon-purple hover:text-neon-blue transition-colors"
                      onClick={() => copyToClipboard("0x8626f6940E2eb28930eFb4CeF49B2d1F2C9C1199", "Fund address copied to clipboard!")}
                    >
                      <Copy size={16} />
                    </button>
                  </div>
                  ...
                  <div className="text-xs text-gray-300 font-pixel">
                    <p>The world's first hedge fund that aims to lose money in the most creative way possible:</p>
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                      <li>Investment strategy: buy high, sell higher, rebuy at the absolute peak</li>
                      <li>Fund managers selected based on most disastrous trading history</li>
                      <li>Performance metric: maximum possible drawdown (we're proud of our -420%)</li>
                    </ul>
                  </div>
                  
                  <div className="mt-4">
                    <div className="flex items-center space-x-2 glassmorphism-2 p-3 rounded-lg bg-opacity-50 border border-neon-purple/20">
                      <div className="text-neon-yellow font-pixel text-sm">Current Fund TVL:</div>
                      <div className="font-mono font-bold text-neon-purple text-xl">$-1,337,420.69</div>
                      <div className="text-neon-green text-xs bg-neon-green/20 px-2 py-0.5 rounded-full">↑ A new low!</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            >
              <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="md:w-2/3">
                  <div className="inline-block bg-neon-green/30 px-3 py-1 rounded-full text-sm mb-3 font-pixel flex items-center space-x-2">
                    <Heart size={16} className="text-neon-green animate-pulse" />
                    <span>Absurdist Charity Initiative</span>
                  </div>
                  
                  <h3 className="text-xl font-bold mb-3 text-neon-green font-pixel w-full">
                    We Donate to Worthy Causes (For Real!)
                  </h3>
                  
                  <div className="text-sm text-gray-300 font-pixel mb-4">
                    <p>Despite all the absurdity, 10% of all AIB tokens are allocated to genuine charitable causes:</p>
                    <ul className="list-disc pl-5 mt-2 space-y-1">
                      <li>Mental health support for crypto traders</li>
                      <li>Environmental initiatives to offset crypto's carbon footprint</li>
                      <li>Education programs teaching financial literacy through memes</li>
                    </ul>
                  </div>
                  
                  <div className="flex items-center justify-between glassmorphism p-3 rounded-lg my-4">
                    <div className="flex items-center space-x-2">
                      <HandCoins className="text-neon-yellow" size={18} />
                      <span className="text-white font-mono text-xs">0x3FE2EC38932898e2Eb7F545d1e8B5b74fd5A6472</span>
                    </div>
                    <button 
                      className="text-neon-yellow hover:text-neon-blue transition-colors"
                      onClick={() => copyToClipboard("0x3FE2EC38932898e2Eb7F545d1e8B5b74fd5A6472", "Donation address copied to clipboard!")}
                    >
                      <Copy size={16} />
                    </button>
                  </div>
                ...
                <div className="md:w-1/3 p-4 glassmorphism rounded-xl bg-neon-green/10 flex flex-col items-center justify-center">
                  <Coffee className="text-neon-yellow w-12 h-12 mb-2" />
                  <h4 className="text-neon-yellow font-pixel text-lg mb-2">Support Our Devs</h4>
                  <p className="text-xs text-gray-300 text-center mb-4 font-pixel">
                    They subsist entirely on caffeine and memes. Your donation keeps this absurdity going!
                  </p>
                  <button 
                    className="bg-neon-yellow text-black px-4 py-2 rounded-full font-pixel text-sm hover:bg-neon-green transition-colors flex items-center space-x-2"
                    onClick={() => copyToClipboard("0x3FE2EC38932898e2Eb7F545d1e8B5b74fd5A6472", "Dev fund address copied to clipboard!")}
                  >
                    <Coffee size={16} />
